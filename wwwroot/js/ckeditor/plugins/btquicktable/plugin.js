CKEDITOR.plugins.add('btquicktable', {
    requires: 'btquicktable,panelbutton,floatpanel',
    ...
    afterInit: function(editor) {
        ...
        editor.ui.add('Table', CKEDITOR.UI_PANELBUTTON, {
            ...
            onBlock: function(panel, block) {
                ...
                var btdata = {
                    'table-bordered': lang.btquicktable.addBorders,
                    'table-striped': lang.btquicktable.addStripes,
                    'table-hover': lang.btquicktable.addHover,
                    'table-condensed': lang.btquicktable.compactStyle,
                };
                panel.bootstrapdata = [];
                for (item in btdata) {
            ...
            addEvents: function(tableWrapper) {
                ...
                tableWrapper.on('keydown', function(evt) {
                    ...
                    if (row > quickRows - 1 || column > quickColumns - 1) {
                        editor.execCommand('btquicktable');
                    }
